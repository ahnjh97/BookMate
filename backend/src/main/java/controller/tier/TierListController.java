...
public class TierListController extends HttpServlet {
    ...
    @Override protected void doGet(HttpServletRequest request,HttpServletResponse response)throws IOException{
        ...
        }catch(NumberFormatException e){send(response,400,"올바른 템플릿 번호가 필요합니다.");}
        catch(IllegalArgumentException e){send(response,400,e.getMessage());}
    ...
    private static class SaveRequest{long templateId;String title;String description;boolean isPublic;List<PlacementRequest> placements;}
    private static class PlacementRequest{long bookId;String grade;}
}
