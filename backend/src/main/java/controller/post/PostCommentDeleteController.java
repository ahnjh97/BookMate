...
@WebServlet("/api/posts/comments/delete")
public class PostCommentDeleteController extends HttpServlet {
    ...
    protected void doPost(
        ...
        final DeleteCommentRequest deleteRequest;
    ...
    /* 2. 요청 JSON 읽기 */
    private DeleteCommentRequest readRequestBody(
            HttpServletRequest request
    ) throws IOException {
